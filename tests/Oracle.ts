...
describe("Oracle", () => {
    ...
    describe("Binance example", async () => {
        ...
        it("should verify oracle response", async () => {
            ...
            const res = await oracle.data(ethers.utils.keccak256(uri + jsps[0]));
    ...
    describe("Manual example", async () => {
        ...
        it("should verify oracle response", async () => {
            ...
            let res = await oracle.data(ethers.utils.id(uri + jsps[0]));
            assert(res.should.be.equal(rslts[0]));
            ...
            res = await oracle.data(ethers.utils.id(uri + jsps[0]));
            assert(res.should.be.equal(rslts[0]));
        });
        ...
        it("should not verify oracle response", async () => {
            ...
            const res = await oracle.data(ethers.utils.id(uri + jsps[0]));
            assert(res.should.be.equal(rslts[0]));
        });
